...
_CREATOR_TOPIC_SIGNALS: list[str] = [
    ...
    "game", "gaming", "minecraft", "valorant", "pubg", "bgmi", "esports", "gameplay",
    "challenge", "prank", "reaction", "shorts", "vlog", "tutorial",
    "tips", "hacks", "recipe", "workout", "fitness", "travel", "beauty",
    "tech", "ai", "gadget", "phone", "coding", "study", "exam", "unboxing", "vs",
    "explained", "comparison", "setup", "launch", "guide", "analysis", "features",
    "update", "first impressions", "how", "what", "why", "build", "test", "live", "podcast",
